...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        # first we want to check if the previous move us a winner
        # this is our base case

        if state.current_winner == other_player:
            # we should return position AND score because We need to keep track of the scoree
            # foe minimax to work
        ...
        if player == max_player:
            ...
            best= {'postion':None,  'score':-math.inf}   # each score should maximize
        ...
        for possible_move in state.avaliable_moves():
            ...
            # step4 :update the dictionary if necessary
